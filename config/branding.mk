...
ifndef
     NAD_VERSION := Nusantara-$(NAD_VERSION_BASE)-$(NAD_BUILD)-$(BUILD_DATE)-$(NAD_BUILD_TYPE)-$(BUILD_TIME)-signed
 ifeq ($(USE_GAPPS),true)
     NAD_VERSION := Nusantara-$(NAD_VERSION_BASE)-$(NAD_BUILD)-Gapps-$(BUILD_DATE)-$(NAD_BUILD_TYPE)-$(BUILD_TIME)-signed
 else ifeq ($(USE_MICROG),true)
     NAD_VERSION := Nusantara-$(NAD_VERSION_BASE)-$(NAD_BUILD)-MicroG-$(BUILD_DATE)-$(NAD_BUILD_TYPE)-$(BUILD_TIME)-signed
 endif
endif
